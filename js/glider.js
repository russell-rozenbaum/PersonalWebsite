...
const CELL_COLOR = 'rgb(248, 243, 231)';
...
function addToggleButton() {
    ...
    button.style.color = 'rgb(248, 243, 231)';
    button.style.fontFamily = 'Bradley Hand, cursive';
...
class GameGrid {
    ...
    render() {
        ...
        for (let cellPos of this.liveCells) {
            ...
            cellElement.style.backgroundColor = CELL_COLOR;
